...
> **Audit remediation.** A full repo audit found four classes of silent failure that survived every release since v0.5. All fixed, with regression tests pinning each one down.
