...
> **Last updated:** 2026-07-04 (v2.7.0 on branch `v2.7`: dashboard-native first-run setup — the terminal wizard is gone from the user-facing surface, replaced by a 5-step overlay panel in the dashboard's app window. See "Recent change history" below — earlier sections of this file may lag a version or two behind.)
