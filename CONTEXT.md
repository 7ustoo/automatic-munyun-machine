...
> **Last updated:** 2026-07-05 (v2.8.0 on branch `v2.8`: "Clear all" button for search terms + the keyword/titles toggle reworked into an in-Resume-card "Search style" control that instantly re-suggests from the current CV. See "Recent change history" below — earlier sections of this file may lag a version or two behind.)
