...
> **Last updated:** 2026-07-03 (v2.5.0 on branch `v2.5`: recency filter (filters.maxJobAge, client-side on card posted-age), resume rescan from the dashboard, and automatic update detection + one-click silent install. See "Recent change history" below — earlier sections of this file may lag a version or two behind.)
