...
> **Last updated:** 2026-07-06 (v3.0.0 on branch `v3.0`: ground-up redesign of `wrapper/dashboard.html` into an app-shell UI — sidebar views, jobs explorer with search/filter/sort, custom modals, restyled setup wizard. Front-end only; zero Go/Node/API changes. See "Recent change history" below — earlier sections of this file may lag a version or two behind.)
