...
> **Last updated:** 2026-07-02 (v2.4.1 on branch `v2.4.1`: .xlsx export with native clickable apply links via new zero-dep scripts/xlsx-writer.mjs; CSV keeps working but is plain text and can't carry hyperlinks. See "Recent change history" below — earlier sections of this file may lag a version or two behind.)
