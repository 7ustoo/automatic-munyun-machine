...
- Optional Dice.com source: one toggle runs your search terms on dice.com too — structured salary ranges, posted dates, and workplace type, merged into the same ranking pipeline
