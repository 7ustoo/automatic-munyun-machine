...
func TestReadFullBatch_AllJobsAndMatched(t *testing.T) {
	dir := t.TempDir()
	writeBatch(t, dir, `[
		{"idx":1,"title":"Senior IAM Engineer","company":"Okta","matchPct":96,"score":31,"matched":["IAM Engineer","Okta","SAML"],"directUrl":"https://x/1","viewjobUrl":"https://hiring.cafe/viewjob/a"},
	...
	if b.Jobs[0].Title != "Senior IAM Engineer" || b.Jobs[0].MatchPct != 96 {
